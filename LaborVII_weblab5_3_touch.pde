  ...
  int stepx=0;
  int stepy=0;
  color wegli1=color(0);
  color wegli2=color(0);
  color wegre1=color(0);
  color wegre2=color(0);
  color wegob1=color(0);
  color wegob2=color(0);
  color wegun1=color(0);
  color wegun2=color(0);
  int P1x=0;
  int P1y=0;
  int P2x=0;
  int P2y=0;
   ...
   if (((mouseoverx >= poswegx2+kartenweg) && (mouseoverx <= poswegx2+kartenweg+kartenweg)) && ((mouseovery  >= poswegy2) && (mouseovery  <=poswegy2+kartenweg))) {//??
      ...
      drop=0; 
        ...
        delay(100);
          ...
          if(spieler==2){
       if (drawob==color(0)&&pts2>=1){
       drop=0;
          fill(255);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
       delay(100);
        }
       if (drawob==color(255)&&pts2>=1){
      drop=0; 
          fill(0);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
        delay(100);
          ...
          if(spieler==3){
       if (drawob==color(0)&&pts3>=1){
       drop=0;
          fill(255);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
       delay(100);
        }
       if (drawob==color(255)&&pts3>=1){
      drop=0; 
          fill(0);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
        delay(100);
         ...
         if(spieler==4){
       if (drawob==color(0)&&pts4>=1){
       drop=0;
          fill(255);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
       delay(100);
        }
       if (drawob==color(255)&&pts4>=1){
      drop=0; 
          fill(0);
          rect(poswegx2+kartenweg, poswegy2, kartenweg, kartenweg );
        delay(100);
  ...
  if (((mouseoverx >= poswegx2+kartenweg) && (mouseoverx <= poswegx2+kartenweg+kartenweg)) && ((mouseovery  >= poswegy2+kartenweg) && (mouseovery  <=poswegy2+kartenweg+kartenweg))) {//??
       ...
       drawob = get(mouseX,mouseY);
       if(spieler==1){
       if (drawob==color(Pirat)&&pts1>=1){
       drop=0;
          fill(Pirat2);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
       delay(100);
       }
       if (drawob==color(Pirat2)&&pts1>=1){
      drop=0; 
          fill(Pirat3);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
            if (drawob==color(Pirat3)&&pts1>=1){
      drop=0; 
          fill(Pirat4);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
               if (drawob==color(Pirat4)&&pts1>=1){
      drop=0; 
          fill(255);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
     ...
     if (drawob==color(0)&&pts1>=1){      
      drop=0; 
       ...
       if(spieler==2){
       if (drawob==color(Pirat)&&pts2>=1){
       drop=0;       
          fill(Pirat2);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
       delay(100);  
        }
       if (drawob==color(Pirat2)&&pts2>=1){
           drop=0; 
          fill(Pirat3);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
            if (drawob==color(Pirat3)&&pts2>=1){
      drop=0; 
          fill(Pirat4);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
               if (drawob==color(Pirat4)&&pts2>=1){
      drop=0; 
          fill(255);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
      ...
      drop=0; 
       ...
       if(spieler==3){
       if (drawob==color(Pirat)&&pts3>=1){
       drop=0;
          fill(Pirat2);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
       delay(100);
        }
       if (drawob==color(Pirat2)&&pts3>=1){
      drop=0; 
          fill(Pirat3);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
            if (drawob==color(Pirat3)&&pts3>=1){
      drop=0; 
          fill(Pirat4);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
               if (drawob==color(Pirat4)&&pts3>=1){
      drop=0; 
          fill(255);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
      ...
      drop=0; 
       ...
       if(spieler==4){
       if (drawob==color(Pirat)&&pts4>=1){
       drop=0;
          fill(Pirat2);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
       delay(100);
        }
       if (drawob==color(Pirat2)&&pts4>=1){
      drop=0; 
          fill(Pirat3);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
            if (drawob==color(Pirat3)&&pts4>=1){
      drop=0; 
          fill(Pirat4);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
       }
               if (drawob==color(Pirat4)&&pts4>=1){
      drop=0; 
          fill(255);
          rect(poswegx2+kartenweg, poswegy2+kartenweg, kartenweg, kartenweg );
        delay(100);
  ...
  if ((mouseoverx >= 55+630/11/3  && mouseoverx <= 55+630/11/3+630/11/3) 
      ...
      drop=0; 
       ...
       if(spieler==4){   if ((mouseoverx >= 885+630/11/3  && mouseoverx <=885+ 630/11/3+630/11/3) 
            && (mouseovery  >=   640&& mouseovery  <=  640+630/11/3 )){
  ...
  if ((mouseoverx >= 885+630/11/3  && mouseoverx <= 885+630/11/3+630/11/3) 
    ...
    if ((mouseoverx >= 310 && mouseoverx <= 380) && (mouseovery  >= 50 && mouseovery  <=100)) {//??
      ...
      if (Admin==1) {
          ...
          PImage bild;
 webImg = loadImage("https://xqskys.de/DVLab/5bild.png");
      bild = loadImage("5bild.png");
      if (bild != null) {
...
int i = 0;   
      while ( i < 200 ) { 
        ...
        if (spieler==1) {
          ...
          Admin=1;
           seeC2=color(0);
                    seeC2=get(55+ 630/11/3/2+630/11/3, 270+ 630/11/3/2);       
          if (seeC2==color(0)) {
            wegob=0;
          } else if (seeC2==color(255)) wegob=1;
                seeC2=color(0);           seeC2=get(55+ 630/11/3/2+630/11/3*2, 270+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)  ) {
            wegre=0;
          } else if (seeC2==color(255)) wegre=1;
                    seeC2=color(0);           seeC2=get(55+ 630/11/3/2, 270+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegli=0;
          } else  if (seeC2==color(255))wegli=1;
                    seeC2=color(0);           seeC2=get(55+ 630/11/3/2+ 630/11/3, 270+ 630/11/3/2+ 630/11/3*2);       
          if (seeC2==color(0)) {
            wegun=0;
          } else  if (seeC2==color(255))wegun=1;
        ...
        if (spieler==2) {
          ...
          text("Karte", 880, 390);
          Admin=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+630/11/3, 270+ 630/11/3/2);       
          if (seeC2==color(0)) {
            wegob=0;
          } else wegob=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+630/11/3*2, 270+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegre=0;
          } else  if (seeC2==color(255))wegre=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2, 270+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegli=0;
          } else  if (seeC2==color(255))wegli=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+ 630/11/3, 270+ 630/11/3/2+ 630/11/3*2);       
          if (seeC2==color(0)) {
            wegun=0;
          } else if (seeC2==color(255)) wegun=1;
        ...
        if (spieler==3) {
          ...
          text("Karte", 55, 765);
          Admin=1;
          seeC2=color(0);           seeC2=get(55+ 630/11/3/2+630/11/3, 640+ 630/11/3/2);       
          if (seeC2==color(0)) {
            wegob=0;
          } else if (seeC2==color(255)) wegob=1;
          seeC2=color(0);           seeC2=get(55+ 630/11/3/2+630/11/3*2, 640+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegre=0;
          } else if (seeC2==color(255)) wegre=1;
          seeC2=color(0);           seeC2=get(55+ 630/11/3/2, 640+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegli=0;
          } else if (seeC2==color(255)) wegli=1;
          seeC2=color(0);           seeC2=get(55+ 630/11/3/2+ 630/11/3, 640+ 630/11/3/2+ 630/11/3*2);       
          if (seeC2==color(0)) {
            wegun=0;
          } else if (seeC2==color(255)) wegun=1;
          if ((mouseoverx >= 55  && mouseoverx <= 55+630/11) 
     ...
     if (stepy==feld) {
        ...
        if (spieler==4) {
          ...
          text("Karte", 880, 765);
          Admin=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+630/11/3, 640+ 630/11/3/2);       
          if (seeC2==color(0)) {
            wegob=0;
          } else if (seeC2==color(255)) wegob=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+630/11/3*2, 640+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegre=0;
          } else if (seeC2==color(255)) wegre=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2, 640+ 630/11/3/2+ 630/11/3);       
          if (seeC2==color(0)) {
            wegli=0;
          } else if (seeC2==color(255)) wegli=1;
          seeC2=color(0);           seeC2=get(885+ 630/11/3/2+ 630/11/3, 640+ 630/11/3/2+ 630/11/3*2);       
          if (seeC2==color(0)) {
            wegun=0;
          } else if (seeC2==color(255)) wegun=1;
          if ((mouseoverx >= 885  && mouseoverx <= 885+630/11) 
      ...
      if ((mouseoverx >= x1  && mouseoverx <= x2) 
        && (mouseovery  >=  y1&& mouseovery  <=  y2)) {//??
          ...
          stroke(0, 0, 0, 0); 
          fill(0);
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1, y1, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, y1+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+kartenweg, y1, kartenweg, kartenweg);
          } else if (seeC2==color(255))
          {
            fill(255);
            rect(x1+kartenweg, y1, kartenweg, kartenweg);
          }  
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg, y1+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg, y1, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg*2+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1, y1+kartenweg*2, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg*2);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg, y1+kartenweg/2+kartenweg*2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg, y1+kartenweg*2, kartenweg, kartenweg);
          }   
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeCb=get(x1+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg);  
           seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg); 
          fill(seeCb);
          rect(x1+kartenweg, y1+kartenweg, kartenweg, kartenweg);
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2, y1+kartenweg/2+kartenweg);       
          if (seeC2==color(0)) {
            fill(0);
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= (x1 + 2*630/feld) && mouseoverx <= x2+2*630/feld) 
          && (mouseovery  >=  y1&& mouseovery  <=  y2)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*630/feld, y1, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+2*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+2*630/feld, y1, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, y1+kartenweg*2+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*630/feld, y1+kartenweg*2, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, y1+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+2*630/feld, y1+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+2*630/feld, y1+kartenweg*2, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, y1+kartenweg+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeCb=get(x1+kartenweg/2+kartenweg+2*630/feld, y1+kartenweg/2+kartenweg);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, y1+kartenweg/2+kartenweg); 
            fill(seeCb);
            rect(x1+kartenweg+2*630/feld, y1+kartenweg, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2+2*630/feld, y1+kartenweg/2+kartenweg);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1 + 4*630/feld) && mouseoverx <= x2+4*630/feld) 
          && (mouseovery  >=  y1&& mouseovery  <=  y2)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+4*630/feld, y1, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+4*630/feld, y1+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+4*630/feld, y1, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, y1+kartenweg*2+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+4*630/feld, y1+kartenweg*2, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+4*630/feld, y1+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+4*630/feld, y1+kartenweg*2, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, y1+kartenweg+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeCb=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg); 
            fill(seeCb);
            rect(x1+kartenweg+4*630/feld, y1+kartenweg, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2+4*630/feld, y1+kartenweg/2+kartenweg);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((mouseoverx >= x1-630/feld  && mouseoverx <= x1) 
        && (mouseovery  >=  y1+ 630/feld&& mouseovery  <=  y2+ 630/feld)) {
          ...
          stroke(0, 0, 0, 0); 
          fill(0);
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1-630/feld, y1+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg-630/feld, y1+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg*2+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1-630/feld, y1+kartenweg*2+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg-630/feld, y1+kartenweg*2+630/feld, kartenweg, kartenweg);
          }   
          seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          } else if (seeC2==color(255))
          {
           ...
           seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld);  
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld); 
          fill(seeCb);
          rect(x1+kartenweg-630/feld, y1+kartenweg+630/feld, kartenweg, kartenweg);
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2-630/feld, y1+kartenweg/2+kartenweg+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= x1 -630/feld && mouseoverx <= x1) 
          && (mouseovery  >=  y1+ 630/feld*3&& mouseovery  <=  y2+630/feld*3)) {
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1-630/feld, y1+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg-630/feld, y1+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg*2+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1-630/feld, y1+kartenweg*2+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg-630/feld, y1+kartenweg*2+630/feld*3, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*3);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*3); 
            fill(seeCb);
            rect(x1+kartenweg-630/feld, y1+kartenweg+630/feld*3, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2-630/feld, y1+kartenweg/2+kartenweg+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1  -630/feld) && mouseoverx <= x1) 
          && (mouseovery  >=  y1+ 630/feld*5&& mouseovery  <=  y2+ 630/feld*5)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1-630/feld, y1+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg-630/feld, y1+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg*2+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1-630/feld, y1+kartenweg*2+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg-630/feld, y1+kartenweg*2+630/feld*5, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2-630/feld, y1+kartenweg+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
           ...
           seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*5);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*5); 
            fill(seeCb);
            rect(x1+kartenweg-630/feld, y1+kartenweg+630/feld*5, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2-630/feld, y1+kartenweg/2+kartenweg+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((mouseoverx >= x1  && mouseoverx <= x2) 
        && (mouseovery  >=  170+630-630/feld && mouseovery  <=  170+630)) {//??
          ...
          stroke(0, 0, 0, 0); 
          fill(0);
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, 170+630-630/feld+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1, 170+630-630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, 170+630-630/feld+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg, 170+630-630/feld+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg, 170+630-630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, 170+630-630/feld+kartenweg*2+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1, 170+630-630/feld+kartenweg*2, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, 170+630-630/feld+kartenweg/2+kartenweg*2);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg, 170+630-630/feld+kartenweg/2+kartenweg*2);       
          if (seeC2==color(0)) {
            fill(0);
            rect(x1+2*kartenweg, 170+630-630/feld+kartenweg*2, kartenweg, kartenweg);
          }   
          seeC2=color(0);           seeC2=get(x1+kartenweg/2, 170+630-630/feld+kartenweg+kartenweg/2);       
          if (seeC2==color(0)) {
            fill(0);
         ...
         seeCb=get(x1+kartenweg/2+kartenweg, 170+630-630/feld+kartenweg/2+kartenweg);  
          seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg, 170+630-630/feld+kartenweg/2+kartenweg); 
          fill(seeCb);
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= (x1 + 2*630/feld) && mouseoverx <= x2+2*630/feld) 
          && (mouseovery  >=  170+630-630/feld&& mouseovery  <=  170+630)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, 170+630-630/feld+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*630/feld, 170+630-630/feld, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+2*630/feld, 170+630-630/feld, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, 170+630-630/feld+kartenweg*2+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*630/feld, 170+630-630/feld+kartenweg*2, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+2*630/feld, 170+630-630/feld+kartenweg*2, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*630/feld, 170+630-630/feld+kartenweg+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
          ...
          seeCb=get(x1+kartenweg/2+kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg); 
            fill(seeCb);
            rect(x1+kartenweg+2*630/feld, 170+630-630/feld+kartenweg, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1 + 4*630/feld) && mouseoverx <= x2+4*630/feld) 
          && (mouseovery  >= 170+630-630/feld&& mouseovery  <=  170+630)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, 170+630-630/feld +kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+4*630/feld, 170+630-630/feld, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+4*630/feld, 170+630-630/feld, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, 170+630-630/feld +kartenweg*2+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+4*630/feld, 170+630-630/feld +kartenweg*2, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+2*kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2+kartenweg*2);       
            if (seeC2==color(0)) {
              fill(0);
              rect(x1+2*kartenweg+4*630/feld, 170+630-630/feld +kartenweg*2, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+4*630/feld, 170+630-630/feld +kartenweg+kartenweg/2);       
            if (seeC2==color(0)) {
              fill(0);
           ...
           seeCb=get(x1+kartenweg/2+kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2+kartenweg);  
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg); 
            fill(seeCb);
            rect(x1+kartenweg+4*630/feld, 170+630-630/feld +kartenweg, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(x1+kartenweg/2+kartenweg*2+4*630/feld, 170+630-630/feld +kartenweg/2+kartenweg);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((mouseoverx >= x1+630-630/feld*2  && mouseoverx <= x1+630-630/feld*2+630/feld) 
        && (mouseovery  >=  y1+ 630/feld&& mouseovery  <=  y2+ 630/feld)) {
          ...
          stroke(0, 0, 0, 0); 
          fill(0);
          seeC2=color(0);           seeC2=get(170+kartenweg/2, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(170+630-630/feld, y1+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg, y1+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(170+630-630/feld+2*kartenweg, y1+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg*2+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(170+630-630/feld, y1+kartenweg*2+630/feld, kartenweg, kartenweg);
          }
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg*2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg, y1+kartenweg/2+kartenweg*2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
            rect(170+630-630/feld+2*kartenweg, y1+kartenweg*2+630/feld, kartenweg, kartenweg);
          }   
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg+kartenweg/2+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
          ...
          seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld);  
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld); 
          fill(seeCb);
          rect(170+630-630/feld+kartenweg, y1+kartenweg+630/feld, kartenweg, kartenweg);
          seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg*2, y1+kartenweg/2+kartenweg+630/feld);       
          if (seeC2==color(0)) {
            fill(0);
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= 170+630-630/feld && mouseoverx <= 170+630-630/feld+630/feld) 
          && (mouseovery  >=  y1+ 630/feld*3&& mouseovery  <=  y2+630/feld*3)) {
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld, y1+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg, y1+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld+2*kartenweg, y1+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg*2+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld, y1+kartenweg*2+630/feld*3, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg*2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg-630/feld, y1+kartenweg/2+kartenweg*2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld+2*kartenweg, y1+kartenweg*2+630/feld*3, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg+kartenweg/2+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            } else if (seeC2==color(255))
            {
             ...
             seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*3);  
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*3); 
            fill(seeCb);
            rect(170+630-630/feld+kartenweg, y1+kartenweg+630/feld*3, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg*2, y1+kartenweg/2+kartenweg+630/feld*3);       
            if (seeC2==color(0)) {
              fill(0);
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (170 +630 -630/feld) && mouseoverx <= 170 +630) 
          && (mouseovery  >=  y1+ 630/feld*5&& mouseovery  <=  y1+ 630/feld*5+630/feld)) {//??
            ...
            stroke(0, 0, 0, 0); 
            fill(0);
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld, y1+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg, y1+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld+2*kartenweg, y1+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg*2+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld, y1+kartenweg*2+630/feld*5, kartenweg, kartenweg);
            }
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg*2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+2*kartenweg, y1+kartenweg/2+kartenweg*2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
              rect(170+630-630/feld+2*kartenweg, y1+kartenweg*2+630/feld*5, kartenweg, kartenweg);
            }   
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2, y1+kartenweg+kartenweg/2+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
            ...
            } else if (seeC2==color(255))
            {
             ...
             seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*5);  
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*5); 
            fill(seeCb);
            rect(170+630-630/feld+kartenweg, y1+kartenweg+630/feld*5, kartenweg, kartenweg);
            seeC2=color(0);           seeC2=get(170+630-630/feld+kartenweg/2+kartenweg*2, y1+kartenweg/2+kartenweg+630/feld*5);       
            if (seeC2==color(0)) {
              fill(0);
...
int i = 0;   
    ...
    if (spieler==1&&turn==2&&(((mouseoverx >= 439 && mouseoverx <= 531) 
          && (mouseovery  >= 439&& mouseovery  <=  531))||touch==1)) {
      fill(0);
      fill(180, 255, 0);              
      rect(40, 360, 90, 40 );
      fill(0);
      ...
      fill(0);
    touch=1;
     if((((mouseoverx >= 439 && mouseoverx <= 531) && (mouseovery  <= 439&& mouseovery  >=  296)))
      ||(((mouseoverx >= 531 && mouseoverx <= 580)  && (mouseovery  >= 439&& mouseovery  <=  531)))
      ||(((mouseoverx >= 439 && mouseoverx <= 531)  && (mouseovery  >= 531&& mouseovery  <=  580)))
      || (((mouseoverx >= 296 && mouseoverx <= 439) && (mouseovery  >= 439&& mouseovery  <=  531)))&&ret==0){
 touch=0;
        ...
        if ( life>=1) {//oben
          ...
          if (((mouseoverx >= 296 && mouseoverx <= 439) && (mouseovery  >= 439&& mouseovery  <=  531))) {
      //   if (((mouseoverx >= 439 && mouseoverx <= 531) && (mouseovery  <= 439&& mouseovery  >=  296))) {
           ...
           if (((mouseoverx >= 531 && mouseoverx <= 580)  && (mouseovery  >= 439&& mouseovery  <=  531))) {
           ...
           if (((mouseoverx >= 439 && mouseoverx <= 531)  && (mouseovery  >= 531&& mouseovery  <=  580))) {
       //unten
            if (P1y<=feld-2) {
         ...
         if (((mouseoverx >= 439 && mouseoverx <= 531) && (mouseovery  >= 296&& mouseovery  <=  439))) {
          ...
          if ((mouseoverx <= 370 || mouseoverx >= 630) 
          && (mouseovery  <= 370|| mouseovery  >=  630)) {
            delay(100);  
            turn=0;
            pts1++;
            if (pts1>=6) pts1=6;
      ...
      }else if(((mouseoverx >= 439 && mouseoverx <= 531) 
          && (mouseovery  >= 439&& mouseovery  <=  531))){ret=0;}
    ...
    } else  if (spieler==2&&turn==2&&(((mouseoverx >= 439 && mouseoverx <= 531) 
          && (mouseovery  >= 439&& mouseovery  <=  531))||touch2==1)) {
        fill(0);
      fill( 180, 255, 0)  ;                
      rect(870, 360, 90, 40 );
      fill(0);
 ...
 touch2=0;
    ...
    }  else  if (spieler==3&&turn==2&&(((mouseoverx >= 439 && mouseoverx <= 531) 
          && (mouseovery  >= 439&& mouseovery  <=  531))||touch3==1)) {
       fill(0);
      fill( 180, 255, 0)  ;                
      rect(40, 730, 90, 40 );
      fill(0);
 ...
 touch3=0;
    ...
    } else if (spieler==4&&turn==2&&(((mouseoverx >= 439 && mouseoverx <= 531) 
          && (mouseovery  >= 439&& mouseovery  <=  531))||touch4==1)) {
       fill(0);
      fill( 180, 255, 0)  ;                 
      rect(870, 730, 90, 40 );
      fill(0);
      ...
      //   if (((mouseoverx >= 439 && mouseoverx <= 531) && (mouseovery  <= 439&& mouseovery  >=  296))) {
       ...
       //unten
         ...
         if (((mouseoverx >= 439 && mouseoverx <= 531) && (mouseovery  >= 296&& mouseovery  <=  439))) {
          ...
          && (mouseovery  >= 439&& mouseovery  <=  531))){ret4=0;}
